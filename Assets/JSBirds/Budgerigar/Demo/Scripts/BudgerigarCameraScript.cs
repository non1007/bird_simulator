...
public class BudgerigarCameraScript : MonoBehaviour
{
	public GameObject target;
	public GameObject budgerigarCamera;
	...
	void Update()
	{
		...
		budgerigarCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
	}
