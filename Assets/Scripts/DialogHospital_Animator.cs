...
/// ダイアログのアニメーション
/// </summary>
public class DialogHospital_Animator : MonoBehaviour
{
    // アニメーター
    [SerializeField]
    ...
    public void Close()
    {
        ...
        petanimator.SetBool("IsIll", false);
    }
    ...
    private void PetHeald()
    {
        Hunger_Status.hunger = 100;
        Cleanliness_Status.cleanliness = 100;
        pet.SetActive(true);
        status.SetActive(Setting_Save.GetBool("StatusActive", false));
        audioSource.Play();
    }
}